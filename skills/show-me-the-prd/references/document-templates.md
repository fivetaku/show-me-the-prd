...
> **개수 4는 사용자 예측가능성의 본질로 유지**. 4종 문서의 정의(어떤 4종을 만들지)는 도메인별 가변.
> 도메인 특화 set은 `references/domain-doc-sets.md` 참조.
...
> 도메인이 명확한 경우(B2B SaaS / 1인 도구 / 이커머스 / 데이터 도구 등) `references/domain-doc-sets.md`에서 4종 정의를 도메인에 맞게 대체할 수 있다. **단 개수 4는 유지**.
